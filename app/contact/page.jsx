...
},
{
  icon:<FaMapMarkerAlt/>,
  title:'Address',
  description:'code corner,Tech Town 1357'
},
]
...
<div className='flex flex-col xl:flex-row gap-[30px]'>
  ...
  <div className='xl:w-[54%] order-2 xl:order-none'>
    <form action='' className='flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl'>
      ...
      <p className='text-white/60'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, animi. Culpa quas consequatur quia!</p>
      {/* input */}
