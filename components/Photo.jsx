...
//           <Image src='/assets/profile.avif' priority quality={100} fill alt='image' className="object-contain"/>
  ...
  return (
    <div className="w-full h-full relative">
      <motion.div initial={{opacity:0}} animate={{opacity:1, transition:{delay:2, duration:0.4,ease:'easeIn'},}}>
        ...
        initial={{opacity:0}} animate={{opacity:1, transition:{delay:2.4, duration:0.4,ease:'easeInOut'},}}
        className="w-[298px] h-[298px] xl:w-[498px] xl:h-[498px] mix-blend-lighten absolute">
          {/* <Image src='/assets/pro1.jpeg' priority quality={100} fill alt='image' className="object-contain"/>
            */}
        </motion.div>
        {/* circle */}
        ...
        xmlns="http://www.w3.org/2000/svg">
          ...
          strokeLinejoin="round" initial={{strokeDasharray:"24 10 0 0"}} animate={{strokeDasharray:["15 120 25 25","16 25 92 72","4 250 22 22"], rotate:[120,360],}}
          transition={{duration:20,repeat:Infinity,repeatType:'reverse'}}
          />
        </motion.svg>
      </motion.div>
